...
if __name__ == '__main__':
    ...
    pickle.dump(act_label_encoder, open('dailydialog/act_label_encoder2.pkl', 'wb'))
    pickle.dump(act_label_decoder, open('dailydialog/act_label_decoder2.pkl', 'wb'))
    pickle.dump(emotion_label_encoder, open('dailydialog/emotion_label_encoder2.pkl', 'wb'))
    pickle.dump(emotion_label_decoder, open('dailydialog/emotion_label_decoder2.pkl', 'wb'))
    ...
    pickle.dump(tokenizer, open('dailydialog/tokenizer2.pkl', 'wb'))
