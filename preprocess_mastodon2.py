...
def load_pretrained_glove():
    ...
    glv_vector = {}
    f = open('/users4/lxdou/data/embedding/glove/glove.840B.300d.txt', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    train_data = create_utterances('mastodon/train_1.json', 'train')
    valid_data = create_utterances('mastodon/dev_1.json', 'valid')
    test_data = create_utterances('mastodon/test_1.json', 'test')
    ...
    pickle.dump(act_label_encoder, open('mastodon/act_label_encoder2.pkl', 'wb'))
    pickle.dump(act_label_decoder, open('mastodon/act_label_decoder2.pkl', 'wb'))
    pickle.dump(emotion_label_encoder, open('mastodon/emotion_label_encoder2.pkl', 'wb'))
    pickle.dump(emotion_label_decoder, open('mastodon/emotion_label_decoder2.pkl', 'wb'))
    ...
    pickle.dump(tokenizer, open('mastodon/tokenizer2.pkl', 'wb'))
    ...
    pickle.dump([convSpeakers, convInputSequence, convInputMaxSequenceLength, convActLabels, convEmotionLabels,
                 train_conv_ids, test_conv_ids, valid_conv_ids], open('mastodon/mastodon2.pkl', 'wb'))
    ...
    np.ndarray.dump(glv_embedding_matrix, open('mastodon/glv_embedding_matrix2', 'wb'))
