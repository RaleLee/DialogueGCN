...
# no use, just copy from train_IEMOCAP
...
def train_or_eval_graph_model(model, loss_function, dataloader, epoch, cuda, optimizer=None, train=False):
    ...
    avg_fscore = round(f1_score(labels,preds, average='macro', labels=[0,2,3,4,5,6])*100, 2)
    # Add precision and recall 
    precision = round(precision_score(labels,preds, average='macro', labels=[0,2,3,4,5,6])*100, 2)
    recall = round(recall_score(labels, preds, average='macro', labels=[0,2,3,4,5,6])*100, 2)
...
if __name__ == '__main__':
    ...
    #                                                               batch_size=batch_size,
    #                                                               num_workers=0)
    train_loader, valid_loader, test_loader = get_DailyDialogue_loaders('dailydialog/daily_dialogue_bert.pkl',
